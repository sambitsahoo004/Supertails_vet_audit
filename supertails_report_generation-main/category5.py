...
class CallConclusionScorer:
    ...
    def _call_llm(self, prompt: str) -> str:
        ...
        try:
            ...
            Be extremely concise, specific, clear and to the point.
            Alway specify about chat service availability and how to access but don't mention about its 24/7 availability'
            """
    ...
    def extract_call_conclusion_section(self, transcript: str) -> str:
        ...
        conclusion_found = any(
            re.search(combined_pattern, line, re.IGNORECASE)
    ...
    def score_call_conclusion(self, transcript: str) -> Dict[str, Any]:
        ...
        results = {
            ...
            "percentage_score": (
                (total_weighted_score / total_max_score) * 100
